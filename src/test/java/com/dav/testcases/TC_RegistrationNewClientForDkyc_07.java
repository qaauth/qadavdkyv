...
public class TC_RegistrationNewClientForDkyc_07 extends BaseClass {
	String clientName;
	String clientEmail;
	// Verify Admin Dav Login Test
		...
		public void verifyRegisterNewClientDetails() throws IOException, InterruptedException {
			...
			clientRegistration.isDkycClientRegistration((System.getProperty("user.dir") + "/documents/CompanyLogo.png"));
